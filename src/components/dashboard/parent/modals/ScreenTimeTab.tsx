...
export default function ScreenTimeTab({ child }: { child: LinkedChildProfile }) {
  ...
  const getProgressColor = () => {
    if (usagePercentage >= 90) return "bg-gradient-to-r from-rose-500 to-red-600";
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-50/50 dark:bg-black/30 border border-slate-200/60 dark:border-slate-800 p-6 rounded-3xl space-y-4">
            <div className="flex justify-between items-start">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-sky-50 dark:bg-sky-950/40 border border-sky-100/10 flex items-center justify-center text-sky-500 shrink-0">
          ...
          <form onSubmit={handleSaveLimit} className="space-y-4">
            ...
            {/* Warning Details */}
            <div className="flex gap-3 p-4 rounded-3xl bg-slate-50 dark:bg-black/20 border border-slate-100 dark:border-slate-800/50">
