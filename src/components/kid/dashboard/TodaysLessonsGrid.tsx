...
const lessons: LessonCard[] = [
  {
    ...
    accent:
      "from-indigo-50 via-white to-white border-indigo-200/70 shadow-indigo-100/60 dark:from-indigo-950/40 dark:via-slate-900 dark:to-slate-900 dark:border-indigo-900/60",
    badgeClassName: "bg-indigo-100 text-indigo-700 dark:bg-indigo-950/60 dark:text-indigo-300",
    icon: BookOpen,
  },
  {
    subject: "Science",
    ...
    accent:
      "from-amber-50 via-white to-white border-amber-200/70 shadow-amber-100/60 dark:from-amber-950/40 dark:via-slate-900 dark:to-slate-900 dark:border-amber-900/60",
    badgeClassName: "bg-amber-100 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300",
    icon: FlaskConical,
  },
];
            ...
            >
              <CardContent className="flex h-full min-h-[220px] flex-col p-5">
                <div className="flex items-center justify-between">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-black/5 dark:bg-slate-800 dark:ring-white/10">
                ...
                <div className="mt-5 space-y-2">
                  <h3 className="text-2xl font-black leading-tight text-slate-950 dark:text-slate-50">
                    {lesson.title}
                  </h3>
