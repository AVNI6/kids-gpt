  ...
  return (
    <main className="min-h-screen flex flex-col px-6 font-sans bg-background relative overflow-hidden">
      <div className="my-auto mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-2 relative z-10 animate-pulse">
        ...
        <div className="rounded-[32px] border-2 border-border/50 bg-card p-8 shadow-xl md:p-10 space-y-6 w-full">
...
/**
 * ClassroomWorkspaceSkeleton - Shared loader for student and teacher classroom details
 */
...
/**
 * TabContentSkeleton - Loading placeholder for individual classroom tab content
 */
    ...
    <div className="animate-pulse space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {[1, 2, 3].map((i) => (
          <Card
            key={i}
            className="rounded-[32px] border-slate-200/50 bg-white/50 dark:bg-slate-900/40 p-6 space-y-4"
          >
            <CardContent className="p-0 space-y-4">
...
/**
 * ClassroomsListSkeleton - Skeleton loader for teacher's classrooms directory
 */
        ...
        <div className="w-full max-w-3xl mx-auto space-y-6 pb-6 p-3 sm:p-6 md:p-8">
          ...
          <div className="flex justify-end">
            <div className="flex items-end gap-3 max-w-[85%] flex-row-reverse">
              ...
              <Skeleton className="rounded-2xl sm:rounded-3xl w-48 h-10 rounded-br-sm" />
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="flex items-end gap-3 max-w-[85%] flex-row">
              <Skeleton className="w-8 h-8 rounded-full shrink-0 mb-1" />
              <div className="rounded-2xl sm:rounded-3xl p-4 bg-card border border-border w-72 h-24 rounded-bl-sm flex flex-col gap-2">
          ...
          <div className="flex justify-end">
            <div className="flex items-end gap-3 max-w-[85%] flex-row-reverse">
              <Skeleton className="w-8 h-8 rounded-full shrink-0 mb-1" />
              <Skeleton className="rounded-2xl sm:rounded-3xl w-36 h-10 rounded-br-sm" />
            </div>
          </div>
        </div>
      </ScrollArea>
