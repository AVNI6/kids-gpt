      ...
      <div className="my-auto mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-2">
        <div className="hidden flex-col gap-8 lg:flex">
          ...
          <div className="relative rounded-[32px] border-2 border-theme-border-light bg-white p-8 shadow-xl">
            <h2 className="mb-4 text-3xl font-bold text-theme-brand">Welcome Back!</h2>
        ...
        <div className="rounded-[32px] border-2 border-theme-border-light bg-white p-8 shadow-xl md:p-10">
          ...
          <div className="mb-8">
            <h2 className="mb-2 text-4xl font-bold text-theme-brand">Sign In</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full rounded-full bg-theme-brand py-4 font-bold text-black shadow-[0_8px_0_rgb(0_77_109)] transition hover:-translate-y-1"
            >
              Sign In 🚀
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-theme-text-secondary">
            New explorer?{" "}
            <Link href="/signup" className="font-semibold text-theme-brand hover:underline">
              Create account
            </Link>
          </p>
        </div>
