-- Migration: Add get_child_comprehensive_data RPC and optimization indexes
-- Date: 2026-06-10 16:06:00

BEGIN;

-- 1. Create optimization indexes for parent dashboard
CREATE INDEX IF NOT EXISTS idx_parent_child_link_parent_child 
ON public.parent_child_link (parent_user_id, child_user_id) 
...
ON public.safety_alerts (user_id) 
WHERE deleted_at IS NULL;

-- 2. Define consolidated child data aggregator RPC
